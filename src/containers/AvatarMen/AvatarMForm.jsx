...
export default function AvatarMForm() {
  return (
    <>
      <div className="container_game">
        <div className="container_option_avatar">
          <div className="container_casco">
            ...
            <FontAwesomeIcon icon={faHardHat} className="casco_cambio_avatar"/>
            <img src="myAvatar 7 1.png" alt="" className="avatar_principal"/>
            </div>
            <div className="container_casco_a">
              <LockIcon className="candado" />
          ...
          <div className="container_avatar">
            ...
            <label htmlFor="" for="cambio_2" id="avatar_cambio_b" >
              <img src="myAvatar 7 2.png" alt="" className="avatar_cambio_b_b" />
              </label>
            ...
            <label htmlFor="" for="cambio_3" id="avatar_cambio_c">
              <img src="myAvatar 6 1.png" alt="" className="avatar_cambio_c_c" />
              </label>
            </div>
            <div className="container_avatar_a">
            <input type="checkbox" id="cambio_4" />
            <label htmlFor="" for="cambio_4" id="avatar_cambio_d">
              <img src="myAvatar 5 1.png" alt="" className="avatar_cambio_d_d" />
              </label>
            </div>
          </div>
        </div>
